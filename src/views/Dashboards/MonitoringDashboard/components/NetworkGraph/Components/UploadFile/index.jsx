...
import SelectField from '../../../CreateJob/components/SelectField';

import { scheduleOptions, youtubeTypes, networkgraph } from 'constants/constants.js';
      ...
      <div className={rootClassName}>
        ...
        <div className={classes.keyWordsHeader}>
          <PortletLabel
            ...
            subtitle="you can get results by uploading file"
          />
        </div>
        <PortletContent
          noPadding
        >
          <Grid item className={classes.keyWordsBody}>
            ...
            <div className={classes.selectTypeYoutube}>
              ...
              {/*  }*/}
              {/*  }*/}
              {/*  options={networkgraph} label={'Type'}*/}
              {/*/>*/}
            </div>
          </Grid>
          {
